                    ...
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{asset("product/images/home/girl1.jpg")}}" class="girl img-responsive" alt="" />
                                    <img src="{{asset("product/images/home/pricing.png")}}"  class="pricing" alt="" />
                                </div>
                            </div>
                            <div class="item">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{asset("product/images/home/girl2.jpg")}}" class="girl img-responsive" alt="" />
                                    <img src="{{asset("product/images/home/pricing.png")}}"  class="pricing" alt="" />
                                </div>
                            </div>
                        ...
                        <div class="col-sm-4">
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    ...
                                    <img src="{{asset("product/images/home/product5.jpg")}}" class="new" alt="" />
                                </div>
                                <div class="choose">
                                    <ul class="nav nav-pills nav-justified">
                                        <li><a href="#"><i class="fa fa-plus-square"></i>Add to wishlist</a></li>
