                        ...
                        <div class="price-range"><!--price-range-->
                            ...
                            <div class="well text-center">
                                <input type="text" class="span2" value="" data-slider-min="0" data-slider-max="600"
                                       data-slider-step="5" data-slider-value="[250,450]" id="sl2" style="width: 100%;"><br/>
                                <b class="pull-left">$ 0</b> <b class="pull-right">$ 600</b>
                            </div>
                        </div><!--/price-range-->

                        <div class="shipping text-center"><!--shipping-->
                            <img src="{{asset("product/images/home/shipping.jpg")}}" alt=""/>
                        </div><!--/shipping-->
...
<<<<<<< HEAD:resources/views/store/pages/index.blade.php
...
=======
                          ...
                          <div class="col-sm-4">
                            <div class="product-image-wrapper" style="box-shadow: 1px 2px 2px gray; height: 350px;">
                                <div class="single-products">
                                    <div class="productinfo text-center">
                                        <a href="{{ route('store.index', $store->id)}}" style="font-size: 25px; color: gray;"><img src="{{asset("images/home/default-logo.png")}}" alt="" style="" />
                                        <hr>
                        ...
                        @endforeach   
>>>>>>> 7193e632608350304705beaa2e268f5d706872e4:resources/views/home/index.blade.php
